...
📌 **Legend for the symbols before recipe names**

| | Meaning |
|--------|----------|
| 🚗 | Good for taking to a potluck |
| 🏠 | Best made and enjoyed at home |
| ❄️ | Requires refrigeration |

> Most recipes were made by following the *America’s Test Kitchen (ATK)* recipes exactly.  
>
> To learn how to follow ATK recipes, please refer to the 👉 [ATK Guide Page](./atk).
